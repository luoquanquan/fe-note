...
- push 函数中将 val 正常添加到 stack1 中, 如果 stack2 为空或者 stack2 栈顶值大于等于 val 时, 则将 val 加入到 stack2 中, 这样保证了 stack2 中的值一定是降序的的并且存储元素的数量会小于等于 stack1.
